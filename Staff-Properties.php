		...
		<div class="menu-bar">
			<div class="menu">
				...
				<ul class="menu-links">
					...
					<li class="nav-link">
						<a href="./Staff-Properties.php" class="dashboard-list-item active">
				...
				<table class="table" id="table">
					...
					<?php
						...
						if($rs){
							...
							<td class='td-action'>
								<a href='./Staff-ViewProperties.php?ViewID=".$PropertyID."' class='custom-tooltip' data-title='View/Edit'><i class='fa-solid fa-eye'></i></a>
							</td>
