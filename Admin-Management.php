							...
							if($rs){
								while ($row = mysqli_fetch_assoc($rs)) {
									...
									<tr>
										...
										<td class='td-action'>
											<a href='./Assets/Php/Admin.php?archiveID=".$ManagementID."&value=Admin' class='custom-tooltip delete-purchase' data-title='Archive'>
											<i class='fa-solid fa-box-archive' ></i>
			...
			<dialog id="Adding-users-modal" class="dialog">
				...
				<div class="container">
					<form  method="POST" class="form adding" enctype="multipart/form-data" action="./Assets/Php/Admin.php">
						...
						<button type="submit" name="Submit"  value="Admin" class="Submit" onclick="AddConfirmation()"><i class="fa-solid fa-user-plus"></i> Add </button> 
					</form>
