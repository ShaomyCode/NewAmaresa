			...
			<div class="menu-bar">
				<div class="menu">
					...
					<ul class="menu-links">
						...
						<li class="nav-link">
							<a href="./Admin-Client.php" class="active">
							...
							if($rs){
								while ($row = mysqli_fetch_assoc($rs)) {
									...
									<tr>
										...
										<td class='td-action'>
											<a href='./Admin-View-Client.php?ViewID=".$PendingID."' class='custom-tooltip' data-title='View/Edit'>
												<i class='fa-solid fa-comment-dots'></i>
											</a>
											

											<a href='./Assets/Php/Admin.php?PromoteID=".$PendingID."' class='custom-tooltip confirm-pending' data-title='Purchased'>
